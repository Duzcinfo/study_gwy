...
* **方法二**：找反对，关键是其余。
  ...
  > 反对关系：  
  > 1.所有S都是p，所有s都不是P。（可以同假，但是不可同真，_**两个所有必有一假**_）    我们班所有都是男士，我们班所有都不是男生。  
...
* 与题目的紧密度（关联性）
  ## 加强方法（5）
* 搭桥法（最强的）：建立联系     遇到“前提”字样，首先想到搭桥。  **论据推出论点**
* 排除他因：加强可能性，不一定是
* 对比实验
* 加强论据：1.补充新论据（有的是原因解释）2.说明原有论据  注意：解释强于举例
* 重复论点
...
* _**因果倒置**_:把原来的因,变成果,果变成因.   **三颗星**

  > 多个削弱共存

* _**否论点**_    **三颗星   【力度最强，最常考】**

找出论点；想出与论点相反意思的表达；寻找对应项
...
1.给定一组对象。如：甲乙丙丁  
2.给出2种或2种以上的信息。如：性别，年龄，身高，职业，爱好，国籍等。  
3.进行信息匹配，推出结论。
